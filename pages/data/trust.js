  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'امانة',en:'TRUST'}, hint:{ar:'TRUST',en:'امانة'} }, { word:{ar:'امين',en:'HONEST'}, hint:{ar:'HONEST',en:'امين'} }, { word:{ar:'حفظ',en:'KEEP'}, hint:{ar:'KEEP',en:'حفظ'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'وديعة',en:'DEPOSIT'}, hint:{ar:'DEPOSIT',en:'وديعة'} }, { word:{ar:'عهد',en:'PLEDGE'}, hint:{ar:'PLEDGE',en:'عهد'} }, { word:{ar:'صدق',en:'TRUTH'}, hint:{ar:'TRUTH',en:'صدق'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'ما الَّذي يَمنعُ الأمينَ مِن الخِيانة؟',en:'What prevents the trustworthy from betrayal?'},opts:[{t:{ar:'خَوفُ النَّاس',en:'Fear of people'},c:false},{t:{ar:'مُراقَبةُ الله',en:'Awareness of Allah'},c:true},{t:{ar:'طَمَعُ المُكافأة',en:'Greed for reward'},c:false}]},{q:{ar:'كيفَ نُحافِظُ على الأمانة؟',en:'How do we guard trust?'},opts:[{t:{ar:'بِتَذَكُّرِ أنَّ اللهَ يَرانا',en:'By remembering Allah sees us'},c:true},{t:{ar:'بِالخَوفِ مِن العِقاب',en:'By fearing punishment'},c:false},{t:{ar:'بِطَلَبِ الشُّهرة',en:'By seeking fame'},c:false}]},{q:{ar:'ماذا يَحدثُ لِمَن خانَ الأمانة؟',en:'What happens to one who betrays trust?'},opts:[{t:{ar:'يَفقِدُ ثِقةَ النَّاس',en:'Loses people’s trust'},c:true},{t:{ar:'يَزدادُ مالُه',en:'His wealth increases'},c:false},{t:{ar:'يُحِبُّهُ النَّاس',en:'People love him'},c:false}]}]}
        ]
      },
