  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'شجاعة',en:'COURAGE'}, hint:{ar:'COURAGE',en:'شجاعة'} }, { word:{ar:'شجاع',en:'BRAVE'}, hint:{ar:'BRAVE',en:'شجاع'} }, { word:{ar:'قلب',en:'HEART'}, hint:{ar:'HEART',en:'قلب'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'ثبات',en:'STEADY'}, hint:{ar:'STEADY',en:'ثبات'} }, { word:{ar:'جراة',en:'BOLD'}, hint:{ar:'BOLD',en:'جراة'} }, { word:{ar:'قوة',en:'STRENGTH'}, hint:{ar:'STRENGTH',en:'قوة'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'ما أَساسُ الشَّجاعَة؟',en:'What is courage’s foundation?'},opts:[{t:{ar:'الإيمانُ بِالله',en:'Faith in Allah'},c:true},{t:{ar:'القُوَّةُ الجَسَديَّة',en:'Physical strength'},c:false},{t:{ar:'المال',en:'Wealth'},c:false}]},{q:{ar:'مَتى يَحتاجُ المُسلِمُ لِلشَّجاعَة؟',en:'When does a Muslim need courage?'},opts:[{t:{ar:'في الحَرب فَقَط',en:'In war only'},c:false},{t:{ar:'في كُلِّ مَوقِف',en:'In every situation'},c:true},{t:{ar:'عند اللَّعِب',en:'When playing'},c:false}]}]}
        ]
      },
