  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'احسان',en:'IHSAN'}, hint:{ar:'IHSAN',en:'احسان'} }, { word:{ar:'خير',en:'GOOD'}, hint:{ar:'GOOD',en:'خير'} }, { word:{ar:'رحمة',en:'MERCY'}, hint:{ar:'MERCY',en:'رحمة'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'عطاء',en:'GIVING'}, hint:{ar:'GIVING',en:'عطاء'} }, { word:{ar:'جمال',en:'BEAUTY'}, hint:{ar:'BEAUTY',en:'جمال'} }, { word:{ar:'اتقان',en:'MASTERY'}, hint:{ar:'MASTERY',en:'اتقان'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'الإحسانُ يَعني:',en:'Ihsan means:'},opts:[{t:{ar:'إتقانُ العَمَلِ ومُراقَبَةُ الله',en:'Excellence in action and awareness of Allah'},c:true},{t:{ar:'الصَّلاةُ فَقَط',en:'Prayer only'},c:false},{t:{ar:'الصِّيامُ فَقَط',en:'Fasting only'},c:false}]},{q:{ar:'مَن يُحِبُّ اللهُ؟',en:'Who does Allah love?'},opts:[{t:{ar:'المُحسِنين',en:'Those who excel'},c:true},{t:{ar:'المُهمِلين',en:'The negligent'},c:false},{t:{ar:'الكُسالى',en:'The lazy'},c:false}]}]}
        ]
      },
