  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'سلام',en:'PEACE'}, hint:{ar:'PEACE',en:'سلام'} }, { word:{ar:'تحية',en:'GREETING'}, hint:{ar:'GREETING',en:'تحية'} }, { word:{ar:'سلم',en:'GREET'}, hint:{ar:'GREET',en:'سلم'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'محبة',en:'LOVE'}, hint:{ar:'LOVE',en:'محبة'} }, { word:{ar:'ادب',en:'MANNERS'}, hint:{ar:'MANNERS',en:'ادب'} }, { word:{ar:'خير',en:'GOOD'}, hint:{ar:'GOOD',en:'خير'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'ما مَعنى «السَّلام» كاسمٍ مِن أَسماءِ اللهِ الحُسنى؟',en:'What does "As-Salaam" mean as one of Allah\'s names?'},opts:[{t:{ar:'الغَفور',en:'The Forgiving'},c:false},{t:{ar:'ذو السَّلامَةِ مِن كُلِّ عَيب',en:'The One free of all faults and harm'},c:true},{t:{ar:'الرَّزَّاق',en:'The Provider'},c:false}]},{q:{ar:'لِماذا يَحتاجُ المُسلِمُ إلى الرَّدِّ على السَّلامِ بِأَحسَن؟',en:'Why does a Muslim need to reply to salam with something better?'},opts:[{t:{ar:'لِأَنَّ القُرآنَ أَمَرَ بِذَلِك ولِزِيادَةِ المَحَبَّة',en:'Because the Quran commanded it and to increase love'},c:true},{t:{ar:'لِأَنَّ مَن يَرُدُّ بِأَقَل يَأثَم كَبيرًا',en:'Because whoever replies with less commits a great sin'},c:false},{t:{ar:'لَيسَ ضَرورِيًّا',en:'It is not necessary'},c:false}]}]}
        ]
      },
