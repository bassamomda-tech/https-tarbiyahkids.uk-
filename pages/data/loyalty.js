  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'وفاء',en:'LOYALTY'}, hint:{ar:'LOYALTY',en:'وفاء'} }, { word:{ar:'عهد',en:'PLEDGE'}, hint:{ar:'PLEDGE',en:'عهد'} }, { word:{ar:'صدق',en:'TRUTH'}, hint:{ar:'TRUTH',en:'صدق'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'امانة',en:'TRUST'}, hint:{ar:'TRUST',en:'امانة'} }, { word:{ar:'ثبات',en:'STEADY'}, hint:{ar:'STEADY',en:'ثبات'} }, { word:{ar:'محبة',en:'LOVE'}, hint:{ar:'LOVE',en:'محبة'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'ما أَوَّلُ مَراتِبِ الوَفاء؟',en:'What is the first rank of loyalty?'},opts:[{t:{ar:'الوَفاءُ لِلأَصدِقاء',en:'Loyalty to friends'},c:false},{t:{ar:'الوَفاءُ للهِ وحدَه',en:'Loyalty to Allah alone'},c:true},{t:{ar:'الوَفاءُ لِلوَطَن',en:'Loyalty to the homeland'},c:false}]},{q:{ar:'مَتى يَبدو الوَفاءُ في أَجمَلِ صُوَرِه؟',en:'When does loyalty show its most beautiful form?'},opts:[{t:{ar:'حينَ يَكونُ سَهلاً ومَريحاً',en:'When it is easy and comfortable'},c:false},{t:{ar:'حينَ يَكونُ صَعباً ومُكلِفاً',en:'When it is difficult and costly'},c:true},{t:{ar:'حينَ يَمدَحُكَ النّاسُ عَلَيه',en:'When people praise you for it'},c:false}]}]}
        ]
      },
