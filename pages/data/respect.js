  ...
  activities: {
    ...
    list: [
      ...
      { id:'scramble', icon:'🔤', kind:'scramble', title:{ar:'رتّب الحروف',en:'Unscramble'},
        levels: [
          { kind:'scramble', points:30, words:[ { word:{ar:'احترام',en:'RESPECT'}, hint:{ar:'RESPECT',en:'احترام'} }, { word:{ar:'توقير',en:'HONOR'}, hint:{ar:'HONOR',en:'توقير'} }, { word:{ar:'ادب',en:'MANNERS'}, hint:{ar:'MANNERS',en:'ادب'} } ] },
          { kind:'scramble', points:30, words:[ { word:{ar:'تقدير',en:'ESTEEM'}, hint:{ar:'ESTEEM',en:'تقدير'} }, { word:{ar:'اكرام',en:'HONORING'}, hint:{ar:'HONORING',en:'اكرام'} }, { word:{ar:'طاعة',en:'OBEY'}, hint:{ar:'OBEY',en:'طاعة'} } ] },
          {kind:'mcq',points:30,items:[{q:{ar:'ما أَساسُ الاحتِرامِ الحَقيقيّ؟',en:'What is the foundation of true respect?'},opts:[{t:{ar:'مَحَبَّةُ اللهِ والتَّقَرُّبُ إِليه',en:'Love of Allah and drawing near to Him'},c:true},{t:{ar:'الخَوفُ مِن العِقاب',en:'Fear of punishment'},c:false},{t:{ar:'الطَّمَعُ في المَدح',en:'Greed for praise'},c:false}]},{q:{ar:'مَتى يَكونُ الاحتِرامُ مَقبولاً عِندَ الله؟',en:'When is respect accepted by Allah?'},opts:[{t:{ar:'حينَ يَكونُ خالِصاً مِن القَلب',en:'When it is sincere from the heart'},c:true},{t:{ar:'حينَ يَكونُ أَمامَ النّاس',en:'When it is before people'},c:false},{t:{ar:'حينَ تَنتَظِرُ مُقابِلاً',en:'When you expect something in return'},c:false}]}]}
        ]
      },
